	...
	<section id="content">
						...
						<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h2><span class="coloured">发布</span>项目</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!-- Form itself -->
                <form name="sentMessage" id="contactForm" action="addproject.php" method="post" novalidate>

                    <div class="control-group">
                        <div class="controls">
                            <input type="text" class="form-control" name="name"
                                   placeholder="项目名字" id="name" required
                                   data-validation-required-message="请输入项目名称" />
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="text" class="form-control"
                                    id="picture" required name="picture"
                                   data-validation-required-message="请上传一张图片" placeholder="输入图片编号"/>
                            <p class="help-block"></p>
                        </div>
				 ...
				 <textarea rows="10" cols="100" class="form-control"
                           placeholder="内容" id="message" required name="message"
                           data-validation-required-message="请输入您的项目内容" minlength="5"
